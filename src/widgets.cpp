...
void nerds::Widgets::render_arrow(ImDrawList* draw_list, const ImVec2& begin_cursor_screen_pos, const ImVec2& point, const float dist, const float angle_radians, ImU32 color){
...
void nerds::Widgets::render_point_angle(ImDrawList* draw_list, const ImVec2& begin_cursor_screen_pos, const ImVec2& point, const float angle_radians, ImU32 color){
    constexpr float dist = 15;
    const ImVec2 screen_point = begin_cursor_screen_pos + point;
    draw_list->AddCircle(screen_point, 5, color);
    render_arrow(draw_list, begin_cursor_screen_pos, point, dist, angle_radians, color);
}